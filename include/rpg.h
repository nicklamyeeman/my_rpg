...
void	display_items(obj_t *, rpg_t *);
void	init_items(obj_t **);
int	event_inv(rpg_t *, sfEvent);
void	do_events(rpg_t *, player_t *);
void	my_item_to_list(obj_t **, char *, char *, int);

rpg_t	init_struct(win_t *);
...
void	dmva_event(win_t *);
void	qvva_event(win_t *, btle_t *, chara_t *, ennem_t *);
void	battle_event(win_t *, btle_t *, chara_t *, ennem_t *);
void	vpae_event(win_t *);
void	toch_event(win_t *);
void	qsvl_event(win_t *, btle_t *);
void	vpls_event(win_t *, btle_t *);
void	vprm_event(win_t *);
void	eavp_event(win_t *);
void	ento_event(win_t *);
void	crit_event(win_t *);
void	ratk_event(win_t *);
void	vpap_event(win_t *, btle_t *);
void	adko_event(win_t *);
void	heal_event(win_t *);
void	vvme_event(win_t *);
void	verx_event(win_t *);
void	fepn_event(win_t *);
void	vapc_event(win_t *);
void	bteq_event(win_t *);
...
void	qdfv_display(win_t *, btle_t *, chara_t *);
void	qvva_display(win_t *, btle_t *, ennem_t *);
void	dmva_display(win_t *, btle_t *);
void	toch_display(win_t *, btle_t *, ennem_t *);
void	vpae_display(win_t *, btle_t *, chara_t *, ennem_t *);
void	qsvl_display(win_t *, btle_t *, chara_t *);
void	vpls_display(win_t *, btle_t *, chara_t *, ennem_t *);
void	vplf_display(win_t *, btle_t *);
void	vprf_display(win_t *, btle_t *);
void	qvvs_display(win_t *, btle_t *, chara_t *);
void	heal_display(win_t *, btle_t *, chara_t *);
void	vprm_display(win_t *, btle_t *, chara_t *);
void	eavp_display(win_t *, btle_t *, chara_t *, ennem_t *);
void	ento_display(win_t *, btle_t *, chara_t *);
void	crit_display(win_t *, btle_t *);
void	ratk_display(win_t *, btle_t *);
void	vpap_display(win_t *, btle_t *);
void	adko_display(win_t *, btle_t *);
void	vvme_display(win_t *, btle_t *);
void	verx_display(win_t *, btle_t *);
void	fepn_display(win_t *, btle_t *);
void	vapc_display(win_t *, btle_t *);
...
pnj_t	*load_pnj();
void	start_game(win_t *, player_t *);
void	new_game(win_t *);
...
void	speone_mage(win_t *, chara_t *, ennem_t *);
void	speone_pala(win_t *, chara_t *, ennem_t *);
void	speone_mene(win_t *, chara_t *);
void	speone_arch(win_t *, chara_t *);
void	speone_vole(win_t *, chara_t *, ennem_t *);
void	spetwo_pala(win_t *, chara_t *);
void	spetwo_mage(win_t *, chara_t *, ennem_t *);
void	spetwo_mene(win_t *, chara_t *);
void	spetwo_vole(win_t *, chara_t *, ennem_t *);
void	spetwo_arch(win_t *, chara_t *);

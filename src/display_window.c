...
{
	(win->f == 34) ? adko_display(win, btle) : 0;
	(win->f == 36) ? vvme_display(win, btle) : 0;
	(win->f == 38) ? verx_display(win, btle) : 0;
	(win->f == 40) ? fepn_display(win, btle) : 0;
	(win->f == 42) ? vapc_display(win, btle) : 0;
...
void	display_window(win_t *win, btle_t *btle, chara_t *p, ennem_t *ennem)
{
	...
	(win->f == 0) ? dmva_display(win, btle) : 0;
	(win->f == 2) ? qdfv_display(win, btle, p) : 0;
	(win->f == 4) ? qvva_display(win, btle, ennem) : 0;
	(win->f == 6) ? vpae_display(win, btle, p, ennem) : 0;
	(win->f == 8) ? toch_display(win, btle, ennem) : 0;
	(win->f == 10) ? qsvl_display(win, btle, p) : 0;
	(win->f == 12) ? vpls_display(win, btle, p, ennem) : 0;
	(win->f == 14) ? qvvs_display(win, btle, p) : 0;
	(win->f == 16) ? heal_display(win, btle, p) : 0;
	(win->f == 18) ? vprm_display(win, btle, p) : 0;
	(win->f == 20) ? vprf_display(win, btle) : 0;
	(win->f == 22) ? vplf_display(win, btle) : 0;
	(win->f == 24) ? eavp_display(win, btle, p, ennem) : 0;
	(win->f == 26) ? ento_display(win, btle, p) : 0;
	(win->f == 28) ? crit_display(win, btle) : 0;
	(win->f == 30) ? ratk_display(win, btle) : 0;
	(win->f == 32) ? vpap_display(win, btle) : 0;
